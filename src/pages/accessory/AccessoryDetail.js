			...
			<div className="detail_container">
				<div className="product-detail-container">
					...
					<div className="product-detail-right">
						...
						{accessoryDetial?.sale_out ? (
							<p className="accessory_sold">Liên hệ</p>
						) : (
							<div className="promotion_price-product">
								<span
									className={
										accessoryDetial?.price_promotion > 0 ? 'product-promotion' : 'price'
									}>
									{formatNumber(accessoryDetial?.price)}₫
								</span>
								{accessoryDetial?.price_promotion > 0 && (
									<p className="price">
										{formatNumber(accessoryDetial?.price_promotion)}₫
									</p>
								)}
							</div>
						)}
